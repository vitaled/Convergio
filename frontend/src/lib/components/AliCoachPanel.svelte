    ...
    <div class="panel-header">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
          ...
          <div>
            <h3 class="font-semibold text-gray-900">Ali Coach</h3>
            <p class="text-xs text-gray-600">AI-Powered Insights</p>
          </div>
        </div>
        <button
          ...
          <div class="space-y-3">
            {#each filteredSuggestions as suggestion (suggestion.id)}
              ...
              >
                ...
                <details class="mb-2">
                  <summary class="cursor-pointer text-xs text-gray-700 hover:text-gray-900">
                    Why this matters →
                  </summary>
      ...
      <div class="collapsed-content">
        <div class="flex items-center justify-center py-4">
          <div class="text-center">
            ...
            <p class="text-xs text-gray-600 mt-1">Ali</p>
          </div>
        </div>
      </div>
    {/if}
