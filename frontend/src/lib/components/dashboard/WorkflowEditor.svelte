  ...
  <div class="flex-1 bg-white flex flex-col">
    ...
    <div class="flex-1 flex">
      ...
      <div class="w-64 bg-gray-100 p-4 overflow-y-auto">
        <h3 class="text-sm font-medium text-gray-900 mb-3">Available Agents</h3>
        <div class="space-y-2">
          {#each availableAgents as agent}
            <button 
              on:click={() => addNode(agent)}
              class="w-full text-left px-3 py-2 bg-white hover:bg-gray-50 rounded border border-gray-200 text-xs"
        ...
        <h3 class="text-sm font-medium text-gray-900 mt-6 mb-3">Instructions</h3>
      ...
      <div 
        bind:this={canvas}
        class="flex-1 relative bg-gray-50 overflow-auto"
    ...
    <!-- Status Bar -->
    <div class="bg-gray-800 text-white px-6 py-2 text-xs flex items-center justify-between">
