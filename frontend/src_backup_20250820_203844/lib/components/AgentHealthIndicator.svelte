...
<div class="agent-health-indicator">
  ...
  {#if showDetails}
    <div class="health-details mt-2 p-2 bg-gray-50 dark:bg-gray-800 rounded text-xs">
      <div class="grid grid-cols-3 gap-2">
        <div class="tool-status">
          <span class="block text-gray-600 dark:text-gray-400">Web Search</span>
        ...
        <div class="tool-status">
          <span class="block text-gray-600 dark:text-gray-400">Vector DB</span>
        ...
        <div class="tool-status">
          <span class="block text-gray-600 dark:text-gray-400">Database</span>
