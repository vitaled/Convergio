		...
		<div class="border-t border-blue-200 pt-3 mt-3">
			<div class="flex space-x-2">
				<button
					...
					disabled={$isThinking}
					class="px-3 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 disabled:bg-gray-400 transition-colors"
				>
...
{:else if !isActive}
	<div class="ali-assistance-inactive bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
		<div class="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-3">
			<span class="text-gray-500 text-lg">🤖</span>
		</div>
		<h3 class="font-medium text-gray-700 mb-1">Ali Assistant</h3>
		<p class="text-sm text-gray-500 mb-3">Get real-time suggestions and improvements</p>
		<button
