...
<div class="resource-board p-6">
  ...
  <div class="mb-6">
    ...
    <p class="text-gray-600">Manage team allocation and capacity</p>
  </div>
    ...
    <div class="flex flex-wrap gap-4 items-center">
      ...
      <div class="flex gap-2">
        <button
          ...
          class="px-3 py-2 rounded {selectedView === 'grid' ? 'bg-blue-600 text-white' : 'bg-gray-100'}"
        >
          Grid View
        </button>
        <button
          on:click={() => selectedView = 'timeline'}
          class="px-3 py-2 rounded {selectedView === 'timeline' ? 'bg-blue-600 text-white' : 'bg-gray-100'}"
        >
          Timeline
        </button>
        <button
          on:click={() => selectedView = 'utilization'}
          class="px-3 py-2 rounded {selectedView === 'utilization' ? 'bg-blue-600 text-white' : 'bg-gray-100'}"
        >
          Utilization
        </button>
      </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 hover:shadow-lg transition-shadow">
          ...
          <div class="flex items-start gap-3 mb-3">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-gray-600">{resource.role}</p>
              <p class="text-xs text-gray-500">{resource.department}</p>
            </div>
          </div>
          ...
          <tbody>
            {#each filteredResources as resource}
              <tr class="border-b hover:bg-gray-50">
                <td class="py-3 px-4">
                  <div class="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div class="text-xs text-gray-500">{resource.role}</div>
                    </div>
                  </div>
                </td>
                <td class="py-3 px-4">
                ...
                <td class="py-3 px-4">
                  <div class="h-8 bg-gray-100 rounded flex items-center px-2 text-xs">
                    Available
                  </div>
                </td>
              </tr>
    ...
    <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="flex items-center gap-4">
            <div class="w-48">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <div class="font-medium">{resource.name}</div>
                  <div class="text-xs text-gray-500">{resource.capacity}h/week</div>
                </div>
              </div>
            </div>
      ...
      <div class="mt-6 pt-6 border-t grid grid-cols-3 gap-4">
        ...
        <div class="text-center">
          ...
          <div class="text-sm text-gray-600">Over-allocated</div>
        </div>
      </div>
    </div>
  {/if}
