...
<div class="bg-white border border-gray-200 rounded">
  <div class="px-4 py-3 border-b border-gray-200">
    <div class="flex items-center justify-between">
      <h3 class="text-sm font-medium text-gray-900">Feedback & Support</h3>
      <button 
    ...
    {:else}
      ...
      {#if stats}
        ...
        <div class="grid grid-cols-2 gap-6 mb-6">
          <div>
            <h4 class="text-xs font-medium text-gray-700 mb-3">By Type</h4>
            <div class="space-y-2">
          ...
          <div>
            <h4 class="text-xs font-medium text-gray-700 mb-3">By Priority</h4>
            <div class="space-y-2">
      ...
      {#if feedback.length > 0}
        <div>
          <h4 class="text-xs font-medium text-gray-700 mb-3">Recent Feedback</h4>
          <div class="space-y-3">
              ...
              <div class="flex items-center justify-between p-3 border border-gray-100 rounded hover:bg-gray-50">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-gray-500 truncate max-w-sm">{item.description}</p>
