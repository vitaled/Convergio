...
<div class="min-h-screen bg-gray-50 space-y-6">
	...
	<div class="flex items-center justify-between">
		<div>
			<h1 class="text-lg font-medium text-gray-900">Projects</h1>
			<p class="mt-1 text-sm text-gray-700">Manage AI agent projects and coordinate workflows</p>
		</div>
		...
		{:else}
			...
			{#if projects.length > 0}
				<div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
					<div class="p-4 border-b border-gray-200 bg-gray-50">
						<h2 class="text-md font-medium text-gray-900">Select Project</h2>
					</div>
					...
					<div class="p-4">
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
							{#each projects as project}
								...
								>
									<div class="font-medium text-gray-900 mb-1">{project.title}</div>
									<div class="text-sm text-gray-600">{project.description || 'No description'}</div>
									<div class="mt-2">
			...
			{:else}
				<div class="bg-white border border-gray-200 rounded-lg">
					<div class="text-center py-20">
						...
						<p class="text-gray-600 mb-6">Create your first project to get started with project management</p>
						<button 
			...
			{#if selectedProjectId && projects.length > 0}
				<div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
					<div class="p-4 border-b border-gray-200 bg-gray-50">
						<div class="flex items-center justify-between">
							<h2 class="text-md font-medium text-gray-900">Project Views</h2>
